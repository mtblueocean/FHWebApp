                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div style="width:100%; display: table; vertical-align: bottom">
                            <p id="exTitleLabel" style="margin-left:30px; margin-top: 20px; font-size: 26px;color: #424242; float: left; font-weight: bold;"></p>
                        </div>
                        <div class="splitterdiv">
                        </div><!--split-->
                        <div class="tablediv">
                ...
                fields: [
                    ...
                    {name: "Calories", title:"Calories(G)", type: "text", width: 20, align:"center"},
                    {
                        ...
                        itemTemplate: function(value, item) {
                            ...
                            if(complete == 0)
                            {
                                return $("<img style='width: 25px; height:25px;' src='{{asset('images/home/uncheck.png')}}'/>");
                            }
                            else
                            {
                                return $("<img style='width: 30px; height:20px;' src='{{asset('images/home/check.png')}}'/>");
                            }
                        }
                    },
                    {name: "Completed", type:"text", visible:false, width: 30}
